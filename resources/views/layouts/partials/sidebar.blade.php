@php
    $menu = [
        ['route' => 'dashboard', 'label' => 'Tableau de bord', 'icon' => 'M4.5 6.5a3 3 0 1 1 5.657 1.343M19.5 6.5a3 3 0 1 1-5.657 1.343M9 12l-1.5 7.5M15 12l1.5 7.5M6 18.5l12-12', 'permission' => 'dashboard.view'],
        ...
        ['route' => 'chantiers.index', 'label' => 'Ateliers Production', 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4', 'permission' => 'chantiers.view'],
...
<aside class="w-64 bg-slate-900 text-white flex flex-col shrink-0">
    <div class="p-5 border-b border-slate-700">
        <x-wantex-logo text-class="text-white" />
    </div>
    ...
    <div class="p-4 border-t border-slate-700">
        <div class="bg-slate-800 rounded-lg p-3 text-center">
            ...
            <p class="text-xs text-slate-400">Gérez votre production textile</p>
        </div>
    </div>
</aside>
